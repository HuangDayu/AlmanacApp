...
public class AlmanacImpl implements Almanac {
	...
	public String getWesternCalendarCN() {
		return TimeUtil.dateFormat(calendar, "yyyy年MM月dd日 HH时mm分ss秒");
	};


	@Override
	public String getWesternCalendarCND() {
        /***
         ...
         */
		String timeStr = "Gyyyy年MM月dd日 HH时mm分ss秒SSS毫秒 Eak时 Z时区 yyyy年第w周第D天 M月第W周第d天";
