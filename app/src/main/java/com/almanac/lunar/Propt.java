...
public class Propt {
	...
	public static Properties getAdministrativeProperties() {
		...
		try {
			propt.load(Propt.class.getClassLoader()
					.getResourceAsStream("assets/administrative.properties"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		return propt;
	...
	public static Properties getLatportProperties() {
		...
		try {
			propt_lat.load(Propt.class.getClassLoader().getResourceAsStream("assets/latport.properties"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		return propt_lat;
	...
	public static Properties getLoogportProperties() {
		...
		try {
			propt_loog.load(Propt.class.getClassLoader().getResourceAsStream("assets/loogport.properties"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		return propt_loog;
